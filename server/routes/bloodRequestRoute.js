...
const { createBloodRequest, getBloodRequests, getUserBloodRequests, updateRequestStatus, manualRequest } = require("../controllers/bloodRequestController");
...
router.route("/bloodBank/blood/manualRequest").post(authenticateBloodBank, authorizeRoles("bloodBank"), manualRequest);
