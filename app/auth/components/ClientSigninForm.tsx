    ...
    return (
        <form className='w-full' onSubmit={handleSubmit(submitData)}>
            ...
            <div className='w-3/4 mx-auto'>
                ...
                <p className='text-zinc-500 text-xs font-normal font-LatoRegular capitalize tracking-[2px] mt-3'>are you a new user? <Link href={'/auth/signUp'} className='text-blue-600 cursor-pointer capitalize underline'>Sign up</Link></p>
            </div>
        </form>
    )
}
