...
const BloodBankNavigation = () => {
    ...
    const isBBOrders = pathname.startsWith('/profile/bloodBank/orders');
    ...
    return (
        <div className={`w-full h-full flex flex-col gap-y-5 pt-8 ${shadow.lightShadow}`}>
            ...
            <Link href={'/profile/bloodBank/orders'}>
                <div className='w-full relative flex items-center gap-x-2 py-2 ps-5'>
                    ...
                    <p className={cx('text-[#1C1A19] font-DMSansBold capitalize', { '!text-bloodBankNavRed': isBBOrders })}>Orders</p>
                </div>
            </Link>
